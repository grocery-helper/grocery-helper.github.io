...
<html>
<head>
<title>Help | Grocery Helper</title>
...
When you purchase your item, it will be aded to your grocery list.">
...
<a href="#" data-toggle="popover" title="Using Your List"
data-content="This is where you can add items to your inventory!
Select the items you have purchased.
When you purchase your item, it will be saved in your inventory.">
<button type="button" class="btn btn-info">Help me use my list!</button></a>
...
echo "<col width=\"200\" style=\"text-align:left>";
echo "<col width=\"30\" style=\"text-align:right\">";
echo "<tr>";
echo "<th>Item</th>";
echo "<th>✅</th>";
echo "<th>🗑️</th>";
...
echo "<input type=\"submit\" name=\"submitGrocery\" value=\"Start Over (erases current list & inventory)\" align='middle' class='addBtn1'/>";
